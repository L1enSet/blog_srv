...
from .views import add_like, add_comment, add_like_comment, editIntro, delete_comment, add_block, add_article_title, add_article_image, edit_block, delete_article_item, edit_article_tags
...
urlpatterns = [
    ...
    path('article_update/edit_intro/<str:article>', editIntro, name="edit_intro"),
