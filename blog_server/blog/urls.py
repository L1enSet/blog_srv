...
from .views import ListArticles, ListArticlesFilter, ViewArticle, ViewCreateArticleF, ViewEditArticle
...
urlpatterns = [
    ...
    path('create_article/', ViewCreateArticleF, name='create_article'),
